...
const testimonials = [
  {
    quote:
      'Working with Maksuda Sultana Nowrin  was a game-changer for our online presence. The new website exceeded our expectations in both design and functionality.',
    name: 'Jerome Bell',
    title: 'CTO, Waverlo',
  ...
  {
    quote:
      'Maksuda Sultana Nowrin  delivered a stunning website that truly reflects our brand’s essence. He continuously involves in feedbacks. Highly recommend his expertise!',
    name: 'Wade Warren',
