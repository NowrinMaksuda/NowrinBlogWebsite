  ...
  return (
    <div className="bg-[#111111] p-1">
      <div className="md:max-w-10/12 mx-auto ">
        ...
        <h1 className="text-white text-7xl md:text-7xl lg:text-[120px] mt-12 font-semibold text-center">
          Maksuda Sultana
        </h1>
        ...
        <div className="space-y-2 absolute mt-14">
          <p className="text-white text-[14px] xl:text-[20px] hidden lg:flex">
            I blend artistry with cutting-edge technology to <br /> deliver
            websites that not only look stunning but also <br /> drive results.
          </p>
